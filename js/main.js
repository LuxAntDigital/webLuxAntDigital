...
$(function () {
    ...
    $('#clock').countdown('2018/09/01 19:00:00').on('update.countdown', function (event) {
        var _DateInput = '' +
    ...
    //Promotional Clock
    $('#promo').countdown('2018/09/01 19:00:00').on('update.countdown', function (event) {
        var _DateInput = '' +
            '<div><span>%D</span> Day%!d</div>' + // valor cambiado de %-d a %D ya que %-d depende de semanas (%-w)
            '<div><span>%H</span> Hours</div>' +
            '<div><span>%M</span> Minutes</div>' +
    ...
    /*$('#clock').countdown('2018/09/01 19:00:00', function(event) {
    ...
    */
    ...
    AmCharts.makeChart("chartdivtwo", {
        "type": "pie",
        "balloonText": "[[title]]<br><span style='font-size:14px'><b>[[value]]</b> ([[percents]]%)</span>",
        "innerRadius": "40%",
        "autoMargins": false,
        ...
        "dataProvider": [{
            ...
            {
                "category": "Marketing &amp; I+D+i",
                "column-1": "2"
            },
            {
                "category": "ETH Reserve",
                "column-1": "2"
            },
            {
            ...
            {
                "category": "Comunity Development",
                "column-1": "0.7"
            },
            {
                "category": "Legal Process Expenses",
                "column-1": "0.5"
            }
        ]
    });
...
function initMap() {
    var _location = {
        lat: 39.88121836326916,
        lng: -4.036413000000039
    };
