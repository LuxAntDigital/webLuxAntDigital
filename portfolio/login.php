...
<?php include "php/head.php" ?> <!-- Head HTML content -->
  ...
  <body class="text-center">
    ...
    <form class="form-signin" method="POST" action="php/loginstart.php">
        ...
        <h1 class="h3 mb-3 font-weight-normal"><?php echo $loginTitle ; ?></h1>
        <label for="inputEmail" class="sr-only" style="::-webkit-input-placeholder{color: black;}"><?php echo $email; ?></label>
        ...
        <input type="password" id="password" class="" placeholder="<?php echo $password; ?>" name="password" required>
         <!-- <div class="checkbox mb-3">
          <label>
            <input type="checkbox" class="check" value="remember-me"> Remember me
          </label>
        </div> -->
        <button class="btn btn-lg btn-primary btn-block" name="buttonlogin" type="submit"><?php echo $signInButton; ?></button>
        <p><?php echo $forgotAlert1; ?> <a href="recovery.php"><?php echo $forgotAlert2; ?></a>.</p>
        <p><?php echo $registerAlert; ?></p>
        <a class="btn secondary-btn xs-hidden" href="register.php"><?php echo $registerButton ; ?></a>
