                        ...
                        <div class="card-body text-left">
                            ...
                            <h4>
                                ...
                                <?php
                                    ...
                                    echo $formulaFinal;
                                    //echo $_POST['price'];
                                    $moneda = $_SESSION['divisa'];
                                    switch($moneda){
                                        case 1: 'Euro';
                                            $aluxValue = $_SESSION['euro'];
                                            $totalPrice = $_SESSION['tokens'] * $aluxValue;
                                            echo $totalPrice;
                                            echo $monedaPrint = ' €';
                                        break;
                                        case 2: 'Dollar';
                                ...
                                <?php echo htmlentities($_SESSION['tokens']) . " " . $amountSend3; ?>
                                <?php                                 
                            ...
                            <div class="text-center">
                                ...
                                <form name="finish" method="POST" action="php/firstBuySuccess.php">
                                    <input type="submit" class="btn" value="<?php echo $buttonFinish; ?>">
                                </form>
                                <a href="../index.php"><button class="btn"><?php echo $buttonCancel; ?></button></a>
                            </div>
                        </div>
                    </div>
                </div>
