...
<?php
    ...
    $ecoBuy = "SELECT nombre, apellidos, email, wallet FROM clientes WHERE email = '" . $_SESSION['email'] . "'";
    $resBuy = mysqli_query($conexion, $ecoBuy);
    while($dataBuy = mysqli_fetch_array($resBuy)){
        $nombre = $dataBuy['nombre'] . " " . $dataBuy['apellidos'];
        $correo = $dataBuy['email'];
        $cartera = $dataBuy['wallet'];
    }
?>
<main>
    <style>
                                            ...
                                            function cambiarPasarela(){
                                                ...
                                                switch(pasarela){
                                                    ...
                                                    case "2":
                                                        ...
                                                        break;
                                                    default:
                                                        $('#comprar').attr('action','finishBuy.php');
                                                        break;
                                                }
