        <div id="advantages" class="onepage-about-us" style="margin-top: 50px;">
        

            <div class="container">
                <div class="modal-body text-center">
                    <h3><?php echo $advantagesTitle; ?></h3>
                    <h4><?php echo $advantagesSubtitle; ?></h4>
                    </br>                        
                    <div class="card-deck mb-3 text-center">
                        <div class="o-common-card col-xl-3">
                            <div class="card-header">
                                <h4 class="my-0 font-weight-normal"><?php echo $quantityTokens1; ?></h4>
                            </div>
                            <div class="card-body">
                                <img alt="Plan Bronce" style="align:center; height:80px; width:80px;" src="BRONCE.PNG">
                        ...
                        <div class="o-common-card col-xl-3" >
                            <div class="card-header">
                                <h4 class="my-0 font-weight-normal"><?php echo $cuantityTokens2; ?></h4>
                            </div>
                            <div class="card-body">
                                <img alt="Plan Plata" style="align:center; height:80px; width:80px;" src="BRONCE.PNG">
                        ...
                        <div class="o-common-card col-xl-3" >
                            <div class="card-header">
                                <h4 class="my-0 font-weight-normal"><?php echo $cuantityTokens3; ?></h4>
                            </div>
                            <div class="card-body">
                                <img alt="Plan Oro" style="align:center; height:80px; width:80px;" src="BRONCE.PNG">
                        ...
                        <div class="o-common-card col-xl-8">
                            <div class="card-header">
                                <h4 class="my-0 font-weight-normal"><?php echo $cuantityTokens4; ?></h4>
                            </div>
                            <div class="card-body">
                                <img alt="Plan Platino" style="align:center; height:80px; width:80px;" src="BRONCE.PNG">
                ...
                <div class="container" style="margin-bottom: 20px;">
                    <a class="btn secondary-btn btn-lg btn-block" href="https://luxantdigitalbank.com/buy.php?lang=<?php echo $langPanel; ?>"><?php echo $buybutton; ?></a>
                </div>
                </br>
            </div>
        </div>
