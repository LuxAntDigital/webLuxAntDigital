...
Alux Bank возвращает власть людям с технологией Blockchain и Smart Contract.
Мы работаем, чтобы жить, мы не живем, чтобы работать!";
$metaKeywords = "банка, криптовалюта, ICO, белая бумага, Alux, Lux, Alux Bank, Lux Ant Digital, Lux Ant Digital Bank, инвестиции, предварительная продажа, предпродажная";
...
$countdownTitle = "ICO открыт! Заканчивается на $0.18";
$capital = "soft cap 10M - hard cap 25M";
$promotion = "ИТОГО ALUX TOKENS 1 МЛРД";
$smallLetters = "ТОКEНOВ ПРОДАННЫЙ: 24,750,545";
$payMethod = "МЫ ПРИНИМАЕМ ЭТИ МЕТОДЫ ОПЛАТЫ ";
...
$microLoans = "МИКРОЗАЙМЫ (КОРПОРАТИВНЫЕ И ЧАСТНЫЕ)";
...
$servicesSubtitle = " Если вы покупаете токены, вы можете получить эти услуги, когда ICO заканчивается";
...
//===============================================================================
$aboutTitle = "O НАС";
$aboutLine1 = "Alux Bank является технологическим стартапом, который фокусируется на проектах и разработках, связанных с цифровыми валютами.";
