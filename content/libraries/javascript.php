    ...
    <script src="js/vendor/easing-1.3.min.js"></script>
    <!-- Bootstrap js -->
    ...
    <!-- Charts -->
    <script src="js/vendor/amcharts.min.js"></script>
    <script src="js/vendor/pie.min.js"></script>
    <!-- Bitcoin -->
    <script src="js/vendor/widget.min.js"></script>
    <!-- wow js -->
